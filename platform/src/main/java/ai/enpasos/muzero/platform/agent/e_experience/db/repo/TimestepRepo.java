...
//        """,
        @Query(value = "SELECT t.id AS id,  t.episode_id AS episodeId,  t.boxa AS boxA, t.boxb AS boxB,  t.u_ok as uOk,  t.nextuok as nextUOk,  t.nextuoktarget as nextUOkTarget,  t.t AS t, t.u_ok_closed AS uOkClosed  FROM timestep t ORDER BY t.id LIMIT :limit OFFSET :offset", nativeQuery = true)
