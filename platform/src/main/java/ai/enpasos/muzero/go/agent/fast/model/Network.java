...
package ai.enpasos.muzero.go.agent.fast.model;
...
import ai.enpasos.muzero.go.agent.fast.model.djl.SubModel;
import ai.enpasos.muzero.go.agent.fast.model.djl.blocks.atraining.MuZeroBlock;
import ai.enpasos.muzero.go.agent.fast.model.djl.blocks.binference.InitialInferenceBlock;
import ai.enpasos.muzero.go.agent.fast.model.djl.blocks.binference.InitialInferenceListTranslator;
import ai.enpasos.muzero.go.agent.fast.model.djl.blocks.binference.RecurrentInferenceBlock;
import ai.enpasos.muzero.go.agent.fast.model.djl.blocks.binference.RecurrentInferenceListTranslator;
import ai.enpasos.muzero.go.agent.fast.model.djl.blocks.cmainfunctions.*;
import lombok.Data;
