...
* Two player zero-sum games with a final reward only:
    * **TicTacToe** is used for integration testing. Starting from scratch it learns perfect play in games from start on a single GPU (NVIDIA GeForce RTX 3090) within 2.000 training steps and 50.000 game plays in half an hour.
...
``` 
    java -jar games/tictactoe/build/libs/tictactoe-0.4.0-SNAPSHOT.jar  
```
