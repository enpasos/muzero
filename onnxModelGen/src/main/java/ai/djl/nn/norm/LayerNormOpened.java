...
public class LayerNormOpened extends AbstractBlock {
    ...
    protected LayerNormOpened(Builder builder) {
    ...
    /**
     * The Builder to construct a {@link LayerNormOpened}.
     */
    public static class Builder {
        ...
        /**
         * Builds a {@link LayerNormOpened} block.
         *
         * @return the {@link LayerNormOpened} block
         */
        public LayerNormOpened build() {
            return new LayerNormOpened(this);
        }
    }
}
