...
public class TicTacToeOnnx {
    ...
    public void run() {
        ...
        List<Shape> inputPrediction = List.of(new Shape(1L, config.getNumChannelsRulesInitial(), w, h), new Shape(1L, config.getNumChannelsRulesRecurrent(), w, h), new Shape(1L, config.getNumChannelsPolicy(), w, h), new Shape(1L, config.getNumChannelsValue(), w, h));
        ...
        List<Shape> inputGeneration = List.of(new Shape(1L, config.getNumCompressedChannelsRulesInitial(), w, h), new Shape(1L, config.getNumCompressedChannelsRulesRecurrent(), w, h), new Shape(1L, config.getNumCompressedChannelsPolicy(), w, h), new Shape(1L, config.getNumCompressedChannelsValue(), w, h), new Shape(1L, a, w, h));
