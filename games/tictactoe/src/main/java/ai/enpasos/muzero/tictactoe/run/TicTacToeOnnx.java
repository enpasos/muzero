...
public class TicTacToeOnnx {
    ...
    public void run() {
        ...
        List<Shape> inputPrediction = List.of(new Shape(1L, config.getNumChannelsAllowedActions(), w, h), new Shape(1L, config.getNumChannelsReward(), w, h), new Shape(1L, config.getNumChannelsPolicy(), w, h), new Shape(1L, config.getNumChannelsValue(), w, h));
        ...
        List<Shape> inputGeneration = List.of(new Shape(1L, config.getNumCompressedChannelsAllowedActions(), w, h), new Shape(1L, config.getNumCompressedChannelsReward(), w, h), new Shape(1L, config.getNumCompressedChannelsPolicy(), w, h), new Shape(1L, config.getNumCompressedChannelsValue(), w, h), new Shape(1L, a, w, h));
