...
@Slf4j
public class Connect4Environment extends EnvironmentZeroSumBase {


    public Connect4Environment(@NotNull MuZeroConfig config) {
        super(config);
    }
    ...
    public float step(@NotNull Action action) {
        ...
        int col = ((Connect4Action) action).getCol();
        int row = ((Connect4Action) action).getRow();
    ...
    public Observation getObservation() {
        return Connect4Adapter.translateToObservation(config, board);
    }
