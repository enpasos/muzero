...
@Component
public class Connect4InferenceHelper {
    ...
    private Connect4InferenceHelper() {
    }
    ...
    public String aiDecision(List<String> actions, boolean withMCTS, String networkDir) {
        ...
        List<Integer> actionInts = actions.stream().map(Connect4InferenceHelper::actionNameToIndex).collect(Collectors.toList());
